...
void CheckOutPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CheckOutPage::*)()>(_a, &CheckOutPage::backRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CheckOutPage::*)()>(_a, &CheckOutPage::bookStatusChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void CheckOutPage::backRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CheckOutPage::bookStatusChanged()
{
