...
void MenuPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->showAllBooks(); break;
        case 1: _t->addBooks(); break;
        case 2: _t->checkOutBook(); break;
        case 3: _t->returnBook(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::showAllBooks, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::addBooks, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::checkOutBook, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::returnBook, 3))
            return;
    }
}
...
// SIGNAL 0
void MenuPage::showAllBooks()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MenuPage::addBooks()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MenuPage::checkOutBook()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void MenuPage::returnBook()
{
